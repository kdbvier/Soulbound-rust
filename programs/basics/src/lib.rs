...
declare_id!("AeEcjMnNVAp78y6eBRcA7t3aUZv7xi9MqdEKXJxuMTAY");
...
pub mod anchor {
    ...
    pub fn init_admin(
        ...
        ctx.accounts.admin_state.bump = [*ctx.bumps.get("admin_state").unwrap()]; // need to store bump for generate seeds
    ...
    pub fn mint_nft(ctx: Context<MintNft>,
        ...
        let bump = *ctx.bumps.get("admin_state").unwrap();
